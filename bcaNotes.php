...
<section class="icons">
<h1 class="heading">BCA Notes</h1>
<h2 class="heading2">notes for all subjects for 2nd sem , 4th sem , 6th sem , 1st sem , 3rd sem , 5th sem of BCA</h2>
...
<div class="dropdown">
  ...
  <div class="dropdown-content">
    ...
    <a href="" target="_blank">c programming</a>
    <a href="" target="_blank">Mathematics</a>
    <a href="" target="_blank">evs</a>
  </div>
</div>
    <div class="dropdown">
  <button class="dropbtn"><h3> 2nd-sem</h3></button>
  <div class="dropdown-content">
    <a href="" target="_blank">Computer Organization</a>
    <a href="" target="_blank">web Programming</a>
    <a href="" target="_blank">OOPs c++</a>
  ...
  <div class="dropdown-content">     
<a href="" target="_blank">System Design</a>
<a href="" target="_blank">Data Structures</a>
<a href="" target="_blank">numerical Methods</a>
...
<div class="dropdown">
  ...
  <div class="dropdown-content">
    ...
    <a href="" target="_blank">Discrete Mathematics</a>
  </div>
</div>
...
<div class="dropdown">
  ...
  <div class="dropdown-content">
    ...
    <a href="" target="_blank">Computer graphics</a>
